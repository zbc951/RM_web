...
@Component({
    selector: 'deposit-speedy-pay',
    templateUrl: 'deposit-speedy-pay.component.html'
})
export class DepositSpeedyPayComponent implements OnInit{

    public bank = [{class: "bankimg",value:"一銀"}];
